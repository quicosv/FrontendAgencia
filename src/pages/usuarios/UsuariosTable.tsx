...
export const UsuariosTable = ({
	...
	return (
		<>
								...
								<tr key={x.idUsuario}>
									...
									<td>
										<button
											...
											id={"btneliminar" + x.idUsuario}
											className="btn btn-danger"
											onClick={() => confirm(x.idUsuario)}
											disabled={usuarioInfo.usuario === x.email}
										>
											Eliminar{" "}
											<span className="visually-hidden">a {x.email}</span>
										</button>
									</td>
								</tr>
							))}
			...
			{refreshUsuarios && (
				<div className="alert alert-warning" role="region" aria-live="polite">
